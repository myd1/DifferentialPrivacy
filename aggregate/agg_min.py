...
temp = pandas.read_csv("agg_min15.csv") #Case 1
#temp = pandas.read_csv("agg_min25.csv") #Case 2

temp['min'] = ((temp['min']//(60))%24)//1 # 12 for case B, 6 for case C, 1 for case D
X = temp[['agg', 'min']] #hour not included in case A
